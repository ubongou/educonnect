...
export default async function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-g50 pb-24">
      <header className="bg-navy bg-dot-blue px-6 py-14 md:py-20">
        <Container>
          <Eyebrow className="text-yellow/80">Welcome to EduConnect</Eyebrow>
          <h1 className="mt-2 font-heading text-[clamp(28px,4vw,44px)] font-extrabold leading-[1.1] text-white">
